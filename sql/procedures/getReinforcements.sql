drop procedure  if exists dbo.getReinforcements
-- =======================================================
...
-- Description: возвращает информацию по субботнему подкрепу

-- exec dbo.getReinforcements 42866
-- =============================================
CREATE PROCEDURE dbo.getReinforcements
(
    @id int
)
AS
