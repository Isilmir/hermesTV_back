...
BEGIN
  ...
  select 61,p.id,0,
  case 
  when honor > (@reinforcements_9-1) then '9 спутников уже в пути к герою'  
  ...
  when honor < @reinforcements_2 then '1 спутник уже в пути к герою'
